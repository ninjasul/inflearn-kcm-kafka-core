...
public class CooperativeStickyConsumer {
    public static final Logger log = LoggerFactory.getLogger(CooperativeStickyConsumer.class);

    public static void main(String[] args) {
        Properties props = buildProperties();

        KafkaConsumer<String, String> kafkaConsumer = buildConsumer(
            props,
            List.of(
                "cooperative-sticky-topic1",
                "cooperative-sticky-topic2"
            )
        );
    ...
    private static Properties buildProperties() {
        ...
        props.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "cooperative-sticky-group");
