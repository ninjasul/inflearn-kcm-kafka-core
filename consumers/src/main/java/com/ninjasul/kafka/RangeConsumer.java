...
public class RangeConsumer {
    public static final Logger log = LoggerFactory.getLogger(RangeConsumer.class);
    ...
    private static Properties buildProperties() {
        ...
        props.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "range-group");
